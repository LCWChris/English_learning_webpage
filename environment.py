...
# 要抓取的 URL
url = "https://breakingnewsenglish.com/environment.html"
...
def scrape_website():
    ...
    if response.status_code == 200:
        ...
        if ul_tag:
            ...
            # 打開 CSV 文件以追加模式寫入
            with open('environment.csv', mode='a', newline='', encoding='utf-8') as file:
                ...
                for li in li_tags:
                    ...
                    if article_response.status_code == 200:
                        ...
                        # 寫入 CSV 文件
                        writer.writerow([date, title, level_tag_content, article_content, "environment"])
                    else:
